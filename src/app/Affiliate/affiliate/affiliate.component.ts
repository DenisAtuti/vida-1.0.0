...
export class AffiliateComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.title.setTitle(
      `vida videos| ${this.affiliate} is one of the best adult and porn content creators`
    );
    this.meta.updateTag({
      name: 'description',
      content: `vida videos the world's best porn sites of ${this.state.getYeah()}. Watch free ${
        this.affiliate
      } porn videos, 
